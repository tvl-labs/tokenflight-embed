...
export function AirplaneLogo(props: { size?: number }) {
  ...
  return (
    <span style={{ "font-size": `${size()}px`, "line-height": "1" }} aria-label="TokenFlight" role="img">✈️</span>
  );
}
...
export function PoweredByKhalani() {
  return (
    <a href="https://khalani.network" target="_blank" class="tf-footer" part="fee-info">
      <span class="tf-footer-text">Powered by</span>
      <KhalaniLogo size={14} />
      <span class="tf-footer-brand">KHALANI</span>
      <ExternalLink size={12} class="tf-footer-arrow" />
    </a>
  );
}
